...
расстановка пробелов и табуляции.
```
...
### Задание 4
выключили транслитерацию и включили нормальный переводчик с русского на английский
```
let ClassStudent = [
...
### Задание 5
в задании 2, можно изменить названия переменных на более осмысленные
```
let apple = 123,
    sliva = '100',
    cherry = true;

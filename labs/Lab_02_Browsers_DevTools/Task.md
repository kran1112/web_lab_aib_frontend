...
Работа включает в себя несколько взаимосвязанных заданий, предпочтительно выполнять ее с использованием браузера Google Chrome. Хотя и в других современных браузерах также доступны инструменты разработчика, которых достаточно для выполнения данных заданий, различия в интерфейсе данных инструментов могут затруднить вашу работу.
